...
//        System.out.println(solution("()))((()"));
    ...
    public static String solution(String p) {
        ...
        System.out.println("solution: "+u+"\t"+v);
        ...
        System.out.println(answer+"\t"+u+"\t"+u.reverse());
...
//        4-5. 생성된 문자열을 반환합니다.
        ...
        System.out.println("solution1: "+u+"\t"+v);
        //        3. 문자열 u가 "올바른 괄호 문자열" 이라면 문자열 v에 대해 1단계부터 다시 수행합니다.
        //        3-1. 수행한 결과 문자열을 u에 이어 붙인 후 반환합니다.
        if(check(u.toString())) {
            return u.append(solution(v.toString())).toString();
...
//        4-2. 문자열 v에 대해 1단계부터 재귀적으로 수행한 결과 문자열을 이어 붙입니다.
//        4-3. ')'를 다시 붙입니다.
        answer.append("(").append(solution1(v.toString())).append(")");
//        4-4. u의 첫 번째와 마지막 문자를 제거하고, 나머지 문자열의 괄호 방향을 뒤집어서 뒤에 붙입니다.
        u.deleteCharAt(0);
        u.deleteCharAt(u.length()-1);
        System.out.println(answer+"\t"+u+"\t"+u.reverse());
        answer.append(u.reverse().toString());
        return answer.toString();
    }
